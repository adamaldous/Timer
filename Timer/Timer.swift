...
class Timer: NSObject {
    ...
    static let kSeconds = "seconds Key"
    static let kComplete = "complete Key"
    ...
    func startTimer() {
        ...
        if !isOn{
            timer = NSTimer.scheduledTimerWithTimeInterval(NSTimeInterval(1), target: self, selector: "secondTick", userInfo: nil, repeats: true)
        }
    }
